...
//búsqueda de empleados
 ...
 public Empleado obtenerPorID(int id) {
    ...
    public boolean guardar(Empleado emp) {
        ...
        String sql = "INSERT INTO public.empleado (nombre, apellido,puesto, telefono, direccion,estado, fecha_in, salario, email) VALUES (?, ?, ?, ?, ?, "
                + "?, ?, ?, ?)";
        ...
        try (Connection conn = connFactory.getConnection();
            ...
            ps.setString(7, emp.getFecha_in());
    ...
    public static boolean validarTelefono(String telefono) {
       ...
       return numeroLimpio.matches(regex);
    }
    ...
    if (emp.getEstado() != null) {
        emp.setEstado(emp.getEstado());
    }
    if (emp.getFecha_in() != null) {
         emp.setFecha_in(emp.getFecha_in());
    }
    if (emp.getSalario() != 0.0) {
        emp.setSalario(emp.getSalario());
    }
    if (emp.getEmail() != null) {
       ...
       String status;
        ...
        String sql = "UPDATE public.empleado SET apellido=?, puesto=?, telefono=?, direccion=?, estado=?, salario=?, email=? WHERE id=?";
